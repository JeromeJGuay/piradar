...
class BearingAlignmentCmd:
    ...
    def __init__(self, data):
        unpacked_data = struct.unpack(self.format, data)
        self.cmd = unpacked_data[0]
        self.bearing_alignment = unpacked_data[1]
...
class GainCmd:
    ...
    def __init__(self, data):
        unpacked_data = struct.unpack(self.format, data)
        self.cmd = unpacked_data[0]
        self.sub_cmd = unpacked_data[1]
        self.gain_auto = unpacked_data[2]
        self.gain = unpacked_data[3]
...
class SeaClutterCmd:
    ...
    def __init__(self, data):
        ...
        self.cmd = unpacked_data[0]
        self.sub_cmd = unpacked_data[1]
        self.sea_clutter_auto = unpacked_data[2]
        self.sea_clutter = unpacked_data[3]
...
class RainClutterCmd:
    ...
    def __init__(self, data):
        ...
        self.cmd = unpacked_data[0]
        self.sub_cmd = unpacked_data[1]
        self.blank = unpacked_data[2]
        self.rain_clutter = unpacked_data[3]
...
class SidelobeSuppressionCmd:
    ...
    def __init__(self, data):
        ...
        self.cmd = unpacked_data[0]
        self.sub_cmd = unpacked_data[1]
        self.sls_auto = unpacked_data[2]
        self.sidelobe_suppression = unpacked_data[3]
...
class AutoSeaClutterNudgeCmd:
    ...
    def __init__(self, data):
        ...
        self.cmd = unpacked_data[0]
        self.sub_cmd = unpacked_data[1]
        self.nudge1 = unpacked_data[2]
        self.nudge2 = unpacked_data[3]
        self.tail = unpacked_data[4]
...
class AntennaHeightCmd:
    ...
    def __init__(self, data):
        unpacked_data = struct.unpack(self.format, data)
        self.cmd = unpacked_data[0]
        self.one = unpacked_data[1]
        self.height_mm = unpacked_data[2]
