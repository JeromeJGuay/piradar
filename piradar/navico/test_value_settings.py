...
for v in side_lobe_suppression_auto:
    ...
    navico_radar.commands('side_lobe_suppression', 10)
    time.sleep(sleep)
    navico_radar.get_reports()
    time.sleep(sleep)
    print("side_lobe_suppression_auto", v, navico_radar.filter.setting.side_lobe_suppression_auto)
